...
export default async function AuthorizePage({
  ...
  return (
    <ConsentShell>
      <ConsentHeader registrableDomain={result.registrableDomain} serviceLabel="pare sessions" />
      ...
      <p className="mb-8 text-sm leading-relaxed text-ink">
        ...
        from an AI agent or chatbot you trust, and you recognize the domain above. Anyone can send
        you this link.
      </p>
      ...
      <form method="post" action={`${config.oauth.baseUrl}/oauth/submit`}>
        ...
        <p className="mb-7 text-[13px] leading-relaxed text-ink-soft">
          Pare stores your triage sessions under the name this code belongs to. Nothing else is
          connected.
        </p>
